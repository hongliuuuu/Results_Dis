...
def mcode(ite):
    ...
    perfonn = [[[0 for k in range(10)] for j in range(10)] for i in range(10)]
    #perfrf = [[[0 for k in range(10)] for j in range(10)] for i in range(10)]
    perfrfdis = [[[0 for k in range(10)] for j in range(10)] for i in range(10)]
    ...
    for i in range(10):
        ...
        for  j in range(len(forestsize)):
            ...
            for k in range(10):
                ...
                res = get_leaf(dataX, newclf, ntrees, md)
